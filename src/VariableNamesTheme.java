public class VariableNamesTheme  {
    public static void main(String[] args) {
        ...
        float takeAwayCoffeeCost = 14.0f;
        System.out.println("Стоимость кофе на вынос = " + takeAwayCoffeeCost);

        //Дата начала (чего-либо)
        String startDate = "12.03.2024";
